...
import { fetchRegister } from '../callApi/processRegister';
...
const Register = () => {
  ...
  const handleSetPassword= (e)=>{
    e.preventDefault();
    fetchRegister({username: email, email: email, password: passwordRef.current.value, avatar: "https://app.dr-psy.com/template/default-avatar.jpg"})
    navigate("/login")
  }
